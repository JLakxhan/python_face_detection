...
SECRET_KEY = '!7h+%_=g$71jaw(ebfddre7+xgwb0m)^2c7sr3-&3bnv#qf=6+'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Add this if using a global templates directory
        'APP_DIRS': True,  # Enables searching app-specific `templates` folders
        'OPTIONS': {
            'context_processors': [
